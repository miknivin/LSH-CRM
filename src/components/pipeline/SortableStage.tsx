...
function SortableStageComponent(
  ...
  return (
    ...
    >
      <div className={`flex sticky z-20 justify-center items-center flex-col mb-2 rounded-t border border-b-2 border-gray-200 border-b-gray-300 p-2.5 dark:border-gray-700 dark:border-b-gray-600 hover:shadow-md top-0 ${isSuccess ? "text-white dark:text-white bg-emerald-500 dark:bg-emerald-600"  : "text-gray-800 dark:text-white/90 bg-white dark:bg-gray-800"}`}>
